        ...
        >
          ...
          <template v-slot:[`item.logo`]="{ item }">
            <v-img
              width="70px"
              class="my-2"
              :src="getImage(item.company_logo)"
            ></v-img>
          </template>
      ...
      <v-card>
          ...
          <div>
            ...
            <v-row>
              <v-col cols="12" sm="12">
                ...
                <v-text-field outlined v-model="companyName"> </v-text-field>
              </v-col>
            </v-row>
            ...
            <v-row>
              <v-col cols="12" sm="12">
                <div>Name</div>
                <v-text-field outlined v-model="contactName"> </v-text-field>
              </v-col>
            </v-row>
            <v-row style="margin-top: -30px">
              <v-col cols="12" sm="6">
                <div>Email Address</div>
                <v-text-field outlined v-model="contactEmail"> </v-text-field>
              </v-col>
              <v-col cols="12" sm="6">
                <div>Phone Number</div>
                <v-text-field outlined v-model="contactNumber" prefix="+62 |">
                </v-text-field>
              </v-col>
            </v-row>
          </div>
        ...
        <v-card-actions class="mt-3 mr-2">
          ...
          <v-btn
            ...
            >Cancel</v-btn
          >
          <v-btn large class="white--text" color="#305F72" @click="postData()">
            Save
          </v-btn>
        </v-card-actions>
        <br />
      ...
      <v-card>
        ...
        <v-card class="mx-6 px-6 pt-3" elevation="1">
          <div>
            ...
            <v-row>
              <v-col cols="12" sm="12">
                <div>Company Name</div>
                <v-text-field outlined v-model="dataCompany.name">
                </v-text-field>
              </v-col>
            </v-row>
            <v-row style="margin-top: -30px">
        ...
        <v-card-actions class="mt-3 mr-2">
          ...
          <v-btn
            ...
            >Cancel</v-btn
          >
          <v-btn large class="white--text" color="#305F72" @click="editData()">
            Save
          </v-btn>
        </v-card-actions>
        <br />
